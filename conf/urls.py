...
router.register(r'ReportCard', ReportCardViewSet) # ReportCard API
router.register(r'event' , EventViewSet , basename='event') # Event API
# Score API
...
urlpatterns = [
    ...
    path('reportcard/' , include('report_card.urls')),
